...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [self.dao firstLaunchCheck];
    
    UIViewController *rootController = [[CompanyViewController alloc]initWithNibName: @"CompanyViewController.xib" bundle: nil];
    ...
    //if first launch then load from CoreData
...
- (void)applicationWillTerminate:(UIApplication *)application
{
    ...
    NSLog(@"COMMAND SHIFT H to exit in simulator");
     [self saveContext];
}
